...
static void MX_GPIO_Init(void) {
    ...
    HAL_GPIO_WritePin(GPIOC, GPS_RST_Pin | ETH_SPDLED_Pin | ADDR0_Pin | ADDR1_Pin | ADDR2_Pin | ETH_LINKLED_Pin | ETH_DUPLED_Pin | LED1_Pin | MEM_RST_Pin | MEM_CS_Pin | MEM_WP_Pin | RF_DIO0_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOA, ADDR3_Pin | ETH_CS_Pin | RF_CS_Pin | RF_RST_Pin | RF_DIO5_Pin | RF_DIO4_Pin | RF_DIO3_Pin, GPIO_PIN_RESET);
    ...
    GPIO_InitStruct.Pin = GPS_RST_Pin | ETH_SPDLED_Pin | ADDR0_Pin | ADDR1_Pin | ADDR2_Pin | ETH_LINKLED_Pin | ETH_DUPLED_Pin | LED1_Pin | MEM_RST_Pin | MEM_CS_Pin | MEM_WP_Pin | RF_DIO0_Pin;
    ...
    GPIO_InitStruct.Pin = ADDR3_Pin | ETH_CS_Pin | RF_CS_Pin | RF_RST_Pin | RF_DIO5_Pin | RF_DIO4_Pin | RF_DIO3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
